...
assoc-G {V} {V} {V} {V} {idV} {idV} {idV} = refl
assoc-G {V} {V} {V} {E} {idV} {idV} {h} = refl
assoc-G {V} {V} {E} {E} {idV} {g} {h} = refl
assoc-G {V} {E} {E} {E} {f} {idE} {idE} = refl
assoc-G {E} {E} {E} {E} {idE} {idE} {idE} = refl

sym-assoc-G : {A B C D : GObj} {f : A ⇒G B} {g : B ⇒G C} {h : C ⇒G D}
            → Gcomp h (Gcomp g f) ≈G Gcomp (Gcomp h g) f
sym-assoc-G {V} {V} {V} {V} {idV} {idV} {idV} = refl
sym-assoc-G {V} {V} {V} {E} {idV} {idV} {h} = refl
sym-assoc-G {V} {V} {E} {E} {idV} {g} {h} = refl
sym-assoc-G {V} {E} {E} {E} {f} {idE} {idE} = refl
sym-assoc-G {E} {E} {E} {E} {idE} {idE} {idE} = refl
```


```agda
identity¹-G : {A B : GObj} {f : A ⇒G B} → Gcomp Gid f ≈G f
identity¹-G {V} {V} {idV} = refl
identity¹-G {V} {E} {f} = refl
identity¹-G {E} {E} {idE} = refl

identityʳ-G : {A B : GObj} {f : A ⇒G B} → Gcomp f Gid ≈G f
identityʳ-G {V} {V} {idV} = refl
identityʳ-G {V} {E} {f} = refl
identityʳ-G {E} {E} {idE} = refl
